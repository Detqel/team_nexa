            ...
            <div className="space-y-4 pt-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Learn from industry experts</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="p-2 bg-white/20 backdrop-blur-sm rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Boost your career prospects</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="p-2 bg-white/20 backdrop-blur-sm rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Flexible and lifetime access</p>
                </div>
              </div>
            </div>
          </div>
