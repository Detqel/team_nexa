        ...
        <div className="relative h-full flex flex-col justify-center px-12 text-white">
          <div className="max-w-lg space-y-6">
            ...
            <p className="text-xl text-white/90">
              Join 50,000+ students already learning on NexaLearn and unlock
              your potential.
            </p>
            <div className="space-y-4 pt-8">
              {[
                ...
                },
                {
                  icon: "🏆",
                  title: "Career Growth",
                  desc: "Get certified and advance your career",
                },
                {
                  icon: "💬",
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <CheckCircle2
                      className={`h-4 w-4 ${password.length >= 8 ? "text-green-600" : "text-muted-foreground"}`}
                    />
                    <span
                      className={
                        password.length >= 8
                  ...
                  <div className="flex items-center gap-2">
                    <CheckCircle2
                      className={`h-4 w-4 ${/[a-z]/.test(password) && /[A-Z]/.test(password) ? "text-green-600" : "text-muted-foreground"}`}
                    />
                    <span
                      className={
                  ...
                  <div className="flex items-center gap-2">
                    <CheckCircle2
                      className={`h-4 w-4 ${/[0-9]/.test(password) ? "text-green-600" : "text-muted-foreground"}`}
                    />
                    <span
                      className={
                        /[0-9]/.test(password)
