      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-muted-foreground mb-4 max-w-sm">
              Transform your career with world-class courses from industry experts. Learn at your own pace and unlock your full potential.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/instructors" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  Become Instructor
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © 2026 NexaLearn. All rights reserved.
          </p>
